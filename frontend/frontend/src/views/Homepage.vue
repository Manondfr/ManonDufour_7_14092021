...
export default {
 ...
 updatePublication(dataId, postImage) {
  ...
  let imageToUpdate = document.querySelector(`.publications__each[data-id="${dataId}"] img`);
