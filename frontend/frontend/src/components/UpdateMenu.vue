...
<template>
    <div class="updateMenu inactive" v-bind:data-id="idPost">
        <h4>Mettre à jour la publication</h4>
        <textarea v-bind:data-id="idPost" v-bind:value="contentPost" @change="onContentChange"></textarea>
        <img v-bind:src="imagePost"/>
        ...
        <img src="#" alt="">
        <button @click="updatePublication(idPost)">Enregistrer les modifications</button>
    </div>
</template>
