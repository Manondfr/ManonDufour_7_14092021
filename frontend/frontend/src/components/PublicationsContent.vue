...
<template>
  <div class="publicationsContent" v-bind:data-id="postId">
    ...
    <img v-if="imageAppearance" v-bind:data-id="postId" v-bind:src="postImage" alt="Image accompagnant la publication"/>
